...
type UserClient interface {
	...
	// 获取用户详情
	GetUser(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*UserReply, error)
	// 获取用户昵称
	GetUserName(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*wrappers.StringValue, error)
	// 获取用户昵称（批量）
	GetUserNameMap(ctx context.Context, in *UserIdsReq, opts ...grpc.CallOption) (*UserNameMapReply, error)
	// 保存用户
	SaveUser(ctx context.Context, in *SaveUserReq, opts ...grpc.CallOption) (*empty.Empty, error)
	// 更新用户
	UpdateUser(ctx context.Context, in *UpdateUserReq, opts ...grpc.CallOption) (*empty.Empty, error)
	// 更新用户状态
	UpdateUserStatus(ctx context.Context, in *UpdateUserStatusReq, opts ...grpc.CallOption) (*empty.Empty, error)
	// 删除用户
	DeleteUser(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *userClient) GetUser(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
...
func (c *userClient) GetUserName(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*wrappers.StringValue, error) {
...
func (c *userClient) SaveUser(ctx context.Context, in *SaveUserReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *userClient) UpdateUser(ctx context.Context, in *UpdateUserReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *userClient) UpdateUserStatus(ctx context.Context, in *UpdateUserStatusReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *userClient) DeleteUser(ctx context.Context, in *wrappers.Int64Value, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type UserServer interface {
	...
	// 获取用户详情
	GetUser(context.Context, *wrappers.Int64Value) (*UserReply, error)
	// 获取用户昵称
	GetUserName(context.Context, *wrappers.Int64Value) (*wrappers.StringValue, error)
	// 获取用户昵称（批量）
	GetUserNameMap(context.Context, *UserIdsReq) (*UserNameMapReply, error)
	// 保存用户
	SaveUser(context.Context, *SaveUserReq) (*empty.Empty, error)
	// 更新用户
	UpdateUser(context.Context, *UpdateUserReq) (*empty.Empty, error)
	// 更新用户状态
	UpdateUserStatus(context.Context, *UpdateUserStatusReq) (*empty.Empty, error)
	// 删除用户
	DeleteUser(context.Context, *wrappers.Int64Value) (*empty.Empty, error)
...
func (UnimplementedUserServer) GetUser(context.Context, *wrappers.Int64Value) (*UserReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUser not implemented")
}
func (UnimplementedUserServer) GetUserName(context.Context, *wrappers.Int64Value) (*wrappers.StringValue, error) {
...
func (UnimplementedUserServer) SaveUser(context.Context, *SaveUserReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveUser not implemented")
}
func (UnimplementedUserServer) UpdateUser(context.Context, *UpdateUserReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUser not implemented")
}
func (UnimplementedUserServer) UpdateUserStatus(context.Context, *UpdateUserStatusReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUserStatus not implemented")
}
func (UnimplementedUserServer) DeleteUser(context.Context, *wrappers.Int64Value) (*empty.Empty, error) {
...
func _User_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUser(ctx, req.(*wrappers.Int64Value))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_GetUserName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserName(ctx, req.(*wrappers.Int64Value))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).DeleteUser(ctx, req.(*wrappers.Int64Value))
	}
	return interceptor(ctx, in, info, handler)
}
